...
export default function Home() {
  ...
  const faqData = [
    ...
    {
      question:
        "Is a security deposit required, and how does it compare to traditional leases?",
      answer:
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div className="bg-gray-50 rounded-lg p-6 text-center">
                  ...
                  <p className="text-gray-600">
                    Say goodbye to unexpected fees. We bundle government
                    charges, setup costs, and essential software subscriptions
                    into one straightforward lease, reducing your initial
                    investment by nearly 40%.
                  </p>
                </div>
                ...
                <div className="bg-gray-50 rounded-lg p-6 text-center">
                  ...
                  <p className="text-gray-600">
                    Whether you're scaling up or testing new markets, our
                    12-month minimum lease gives you the freedom to adapt
                    quickly—no more locking into long, inflexible contracts.
                  </p>
                </div>
                ...
                <div className="bg-gray-50 rounded-lg p-6 text-center">
                  ...
                  <p className="text-gray-600">
                    Keep your capital where it belongs—in your business. Our
                    lower deposit requirements free up your cash flow, so you
                    can invest in growth, marketing, or operations instead.
                  </p>
                </div>
                ...
                <div className="bg-gray-50 rounded-lg p-6 text-center">
                  ...
                  <p className="text-gray-600">
                    When you factor in total costs over the lease term, tenants
                    save up to 15% compared to traditional leases. It's smarter
                    leasing without compromising on quality or support.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="bg-gray-50 rounded-lg p-6">
                  <p className="text-gray-700 italic mb-4">
                    "Switching to this leasing model was a game changer. Lower
                    upfront costs meant we could invest more in expanding our
                    product line. The flexible lease term gave us the freedom to
                    grow without the pressure of a long contract."
                  </p>
                ...
                <div className="bg-gray-50 rounded-lg p-6">
                  <p className="text-gray-700 italic mb-4">
                    "The reduced deposit made it possible for us to secure the
                    space we needed while keeping cash available for operations.
                    Highly recommend for any growing business."
                  </p>
                  <div className="text-right">
                ...
                <div className="bg-gray-50 rounded-lg p-6">
                  <p className="text-gray-700 italic mb-4">
                    "The streamlined leasing process and bundled costs took away
                    a lot of the usual headaches. It's an ideal solution for
                    businesses like ours needing flexibility and cost control."
                  </p>
                  <div className="text-right">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Listen to our latest podcast episode discussing the financial
              returns on investment for PMEP factory operations.
            </p>
            <div className="bg-gray-50 rounded-lg p-6">
              <iframe
      ...
      <section className="py-10 bg-gray-50">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center">
            <Link
              href="/listings"
              className="px-6 py-3 bg-white rounded-lg shadow hover:shadow-lg font-semibold text-blue-900 border border-blue-100"
            >
              Factory Listings
            </Link>
            <a
